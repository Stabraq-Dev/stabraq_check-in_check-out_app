...
export const VALUES_MATCHED_RANGES = ['Func!C2:N2', 'Func!A4:G4'];
export const LAST_BLANK_ROW_RANGE = 'Func!A6';
export const TRAINING_ROOM_RATE_RANGE = 'Func!A8';
export const PRIVATE_ROOM_RATE_RANGE = 'Func!B8';
export const SHARED_HR_RATE_RANGE = 'Func!C8';
export const SHARED_FULL_DAY_RATE_RANGE = 'Func!D8';
export const GIRLS_HR_RATE_RANGE = 'Func!E8';
export const GIRLS_FULL_DAY_RATE_RANGE = 'Func!F8';
